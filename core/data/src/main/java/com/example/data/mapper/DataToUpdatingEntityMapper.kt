...
class DataToUpdatingEntityMapper @Inject constructor(): Mapper<CharacterData, CharacterUpdatingEntity> {
    override fun invoke(data: CharacterData): CharacterUpdatingEntity =
